...
app.put('/updateprofileUser', authenticateJWT, authorize(["Người dùng"]), updateProfileUser);
app.put('/profile/changepasswordUser', authenticateJWT, authorize(["Người dùng"]), changePasswordUser); 
///
...
app.get('/order/:orderId', authenticateJWT, authorize(["Người dùng"]), getOrderDetails);
